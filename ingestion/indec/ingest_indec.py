"""Ingest INDEC exports CSV from datos.gob.ar into the Bronze S3 layer."""
...
def make_s3_key(filename: str, ingestion_dt: date | None = None) -> str:
    ...
    Pattern: source=indec/year=YYYY/month=MM/<filename>
    """
...
async def main() -> None:
    console.rule("[bold green]INDEC — Bronze ingestion")
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        raw_name = resource.get("name", "INDEC exports by province and destination")
