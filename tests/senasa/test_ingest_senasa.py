"""Tests for ingestion/senasa/ingest_senasa.py."""
...
from ingestion.senasa.ingest_senasa import fetch_csv_resource, make_s3_key
...
def test_make_s3_key_explicit_date():
    ...
    assert key == "source=senasa/year=2024/month=03/f.csv"
